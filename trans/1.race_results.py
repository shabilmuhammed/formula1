...
circuits_df = spark.read.format('delta').load('/mnt/formula1dl007/processed/circuits') \
...
drivers_df = spark.read.format('delta').load('/mnt/formula1dl007/processed/drivers') \
...
races_df = spark.read.format('delta').load('/mnt/formula1dl007/processed/races') \
.withColumnRenamed('race_timestamp','race_date') \
.withColumnRenamed('name','race_name')

# COMMAND ----------

results_df = spark.read.format('delta').load('/mnt/formula1dl007/processed/results') \
...
constructors_df = spark.read.format('delta').load('/mnt/formula1dl007/processed/constructors').withColumnRenamed('name','team')
